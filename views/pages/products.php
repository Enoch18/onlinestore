            ...
            <div class="container py-3">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-10 offset-md-0 offset-sm-1">
                        <div class="card"> 
                            <img class="card-img-top" src="<?php echo $product->thumbnail; ?>">
                            <div class="card-body">
                                <h6 class="font-weight-bold pt-1"><?php echo $product->name; ?></h6>
                                <div class="text-muted description"><?php echo $product->description; ?></div>
                                ...
                                <div class="d-flex align-items-center justify-content-between pt-3">
                                    <div class="d-flex flex-column">
                                        <div class="h6 font-weight-bold"><?php echo $product->price; ?></div>
